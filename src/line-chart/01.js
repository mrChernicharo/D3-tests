...
let timeScale = d3
	...
	// .range([0, width]); //fica muito perto da margem esquerda
	.range([30, width - 60]);

// cria UM TICK por dia independente da quantidade de dataPoints
let dates = timeScale.ticks(d3.timeDay);
// let dates = timeScale.ticks(d3.timeMonth);
